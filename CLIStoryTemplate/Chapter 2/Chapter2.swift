    ...
    while true {
        ...
        if let input = userInputYes {
            if input.lowercased() == "yes" {
                ...
                print("Reid Wiseman is a 44 year old male climatologists from Jueanu Alaska.")
                break
            } else {
                print("Access Denied")
            }
